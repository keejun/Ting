...
<script src="appjs/newtopic.js" charset="gb2312" ></script>
...
<div id="gr">Ting小组<div style="font-size:12px">与您喜欢的音乐话题不期而遇</div></div>
 ...
 <div id="newtopic">
      <% if(user==null){%>
       <%} else {%>
       <form action="" name="newtopic" method="post" onsubmit="return checkques(newtopic)"><%}%>
       <ul><li><span id="ques1">创建新话题</span> <span id="backtogroup"><a href="<%=basePath%>group.jsp">回到话题组</a></span></li><br/>
            <li><div></div></li><br/>
            <li>
              <input type="text" name="question" id="question" placeholder="新话题" ></li><span id="tiwen"></span><br/>
            <li>
              <textarea id="ques" name="ques" placeholder="话题内容" ></textarea><span id="tiwentip"></span></li><br/>
